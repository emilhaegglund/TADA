rule download_gtdb_metadata:
    output:
        "gtdb_data/{domain}_metadata_r214.tsv"
    params:
        output_dir="gtdb_data/",
        zip_file="gtdb_data/{domain}_metadata_r214.tar.gz",
        url="https://data.ace.uq.edu.au/public/gtdb/data/releases/release214/214.0/{domain}_metadata_r214.tar.gz"
    shell:
        """
...
rule download_gtdb_phylogenies:
    output:
       "gtdb_data/{domain}_r214.tree"
    params:
        output_dir="gtdb_data/",
        url="https://data.ace.uq.edu.au/public/gtdb/data/releases/release214/214.0/{domain}_r214.tree"
    shell:
        """
        wget -P {params.output_dir} {params.url}
        """
...
rule remove_suppressed_records_from_metadata:
    input:
        metadata="gtdb_data/{domain}_metadata_r214.tsv",
    ...
    output:
        "gtdb_data/{domain}_metadata_r214.wo_suppressed_records.tsv",
    script:
        "../scripts/remove_suppressed_records_from_metadata.py"

rule merge_metadata_tables:
    input:
        bac_metadata="gtdb_data/bac120_metadata_r214.wo_suppressed_records.tsv",
        ar_metadata="gtdb_data/ar53_metadata_r214.wo_suppressed_records.tsv"
    output:
        "gtdb_data/metadata_r214.wo_suppressed_records.tsv"
    script:
